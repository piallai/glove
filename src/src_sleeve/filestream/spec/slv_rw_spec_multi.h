...
#include "filestream/spec/slv_rw_spec_std_list_decl.h"
#include "filestream/spec/slv_rw_spec_std_deque_decl.h"
#include "filestream/spec/slv_rw_spec_std_map_decl.h"
...
#include "filestream/spec/slv_rw_spec_boost_unordered_map_decl.h"
#endif
